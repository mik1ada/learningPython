...
├── projectsPython/          # Projekty i zadania realizowane w ramach kursu Python KW
│   └── coursePythonKW/
│       ├── basics/          # Przykłady użycia podstawowych elementów języka Python
│       └── tasks/           # Podstawowe zadania z kursu
│
