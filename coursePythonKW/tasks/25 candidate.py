...
if experience >= 2 and 'python' in languages and 'java' in languages:
  if contractType == "b2b" or contractType == "employment":
    print("Gratulacje spelniasz nasze wymagania i zostales przyjety.")
  else:
    print("Nie odpowiada nam preferowany przez ciebie sposob zatrudnienia:" , contractType)
else:
  print("Nie posiadasz odpowiedniego doswiadczenia na te stanowisko.")
