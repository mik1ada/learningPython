...
startPrice = float(input("Wprowadz cene startowa: "))
discount = float(input("Wprowadz wielkosc rabatu w procentach: "))

finalPrice = calculateFinalPrice(startPrice, discount)
print("Cena ostateczna wynosi:", finalPrice)